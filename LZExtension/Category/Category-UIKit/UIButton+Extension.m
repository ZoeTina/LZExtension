...
@dynamic event;
- (void)handleControlEvent:(UIControlEvents)event withBlock:(YYActionBlock)block
{
...
{
    YYActionBlock block = (YYActionBlock)objc_getAssociatedObject(self, &overviewKey);
